...
public interface Gui extends Link {
	...
	/**
	 * Called when a player clicks on the inventory The event is cancelled before
	 * the call so if someone for some reason wants to re-enable it (idk why) he/she
	 * could
	 * 
	 * @param event
	 *            the click event
	 ...
	 * 
	 * @param player
	 *            the player that closed the door
	 */
	 ...
	 * 
	 * @param player
	 *            the player that executes this link
	 */
	@Override
