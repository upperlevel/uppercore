...
public interface Link {
    ...
    /**
     * Creates a link that runs a commands with Console privileges (Bukkit.getConsoleSender())
     *
     * @param command the commands to be runned (with &lt;player&gt; as the player's name)
     * @return a new link that executes the commands passed as argument with Console privileges
     */
    ...
    /**
     * Creates a link that runs a commands with the executor privileges (the link executor)
     *
     * @param command the commands to be runned (with &lt;player&gt; as the player's name)
     * @return a new link that executes the commands passed as argument with the executor privileges
     */
